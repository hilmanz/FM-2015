 ...
 */
	Configure::write('Security.salt', sha1('X43alds;1jdsa;lsai21ljdas'));

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '5504002392193928129');
...
if(@$_SESSION['league']=='ita'){
    Configure::write('API_URL','http://localhost:3022');
}else{
