	...
	<div class="content">
		<div class="row-2">
			...
			<div class="col-content">
		      	...
		      	<h4>Purchase Order : <?=$rs_doku['MerchandiseOrder']['po_number']?></h4>
		      	<h4>Kode Pembayaran : <?=$rs_doku['Doku']['paymentcode']?></h4>
				<h3>Terima Kasih!</h3>
	    ...
	    <div class="rowd">
	    	<div class="detil-transaksi">
		        ...
		        <h3>Tata Cara Pembayaran via ATM</h3>
		            ...
		            <li>7. Masukkan Nomor Rekening tujuan dengan menggunakan Nomor Kode Pembayaran. Contoh : 8965011111111111 lalu tekan "Benar"</li>
